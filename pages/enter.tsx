            ...
            <div className="mt-8">
                <div className="flex flex-col items-center">
                    ...
                    <div className="grid border-b w-full mt-8 grid-cols-2 gap-16">
                        <button className={buttonCLS("pb-4 font-medium", method === "email" ? "border-b-2 border-orange-500 text-orange-400" : "border-transparent text-gray-500")} onClick={onEmailClick}>Email address</button>
                        <button className={buttonCLS("pb-4 font-medium", method === "phone" ? "border-b-2 border-orange-500 text-orange-400" : "border-transparent text-gray-500")} onClick={onPhoneClick}>Phone number</button>
                    </div>
                </div>
