    ...
    return (
        <div>
            ...
            <div className="flex cursor-pointer mb-3 py-3 boreder-t border-b items-center space-x-3">
                ...
                <div>
                    <p className="text-sm font-medium text-gray-700 ">박기웅</p>
            ...
            <div className="px-4 my-5 space-y-5">
                <div className="flex items-start space-x-3">
                    ...
                    <div>
                        <span className="text-sm block font-medium text-gray-700">박기웅</span>
            ...
            <div className="px-4">
                <textarea className="resize-none mt-1 shadow-sm w-full focus:ring-orange-500 rounded-md border-gray-300 focus:border-orange-500" rows={4} placeholder="Answer this question"/>
